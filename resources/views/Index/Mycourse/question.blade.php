...
<div class="memblist">
    ...
    <div class="memb">
        <ul>
        	<li class="mb3"><a class="mb1" href="">我的课程</a></li>
    		<li><a class="currnav" href="/index/mycourse/question">我的问答</a></li>
...
<div class="membcont">
    ...
    <div class="box demo2" style="width:820px;">
       <div class="coursetext">
        @foreach($list as $v)
    	<h3><a class="artlink" href="{{url('/index/mycourse/questions/'.$v->q_id)}}">{{$v['q_title']}}</a></h3>
        <p>{{$v['q_name']}}</p>  
        <p class="artilabel">   
        <span class="ask_label">热门提问</span></p>
        <b class="labtime">{{date('Y-m-d H:i:s',$v['q_time'])}}</b>      
        <div class="clearh"></div>
        @endforeach
    <!-- 结束 -->
    </div>
