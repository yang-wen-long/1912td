...
<div class="coursecont">
    ...
    <ul class="courseul pageul">
        ...
        <li class="curr"><a href="{{url('/index/page/help_center')}}" >帮助中心<b></b></a></li>
    ...
    <div class="courseright pageright" style="min-height:500px;">
        ...
        <div class="pagetext">
            <span class="pagemap">
                <embed src="/uploads/mp3/8a583d4a91d057a462df4c9a184fd011.mp4" type='' width="740px" height="400px" preload="none">
            </span>
        </div>
    </div>
    <div class="clearh"></div>
